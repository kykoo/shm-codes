...
//
int outPin = 2;
int status = 0;      // the current state of the output pin
...
void loop()
{
	...
	// status 1: PPS    mode    true          working   dead
	// status 2: Silent mode    false         dead      dead
	// status 3: DAQ    mode    false         dead      working
